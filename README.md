# face-emotion-regconition_
Face and emotion detection and regconition.This is the simple web app using Flask for regconition human faces and their emotion. The project uses opencv for dealing with image processing captured from camera and haarcascade_frontalface_default to crop the coord 
of detected face<br>
